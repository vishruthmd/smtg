...
-   [GitHub Repository](https://github.com/vishruthmd/5idiots_RVCE_1_VishruthMD) - Main code repository
-   [Project Documentation](https://github.com/vishruthmd/5idiots_RVCE_1_VishruthMD/tree/main/docs) - Complete documentation overview
-   [Project Presentation](https://www.canva.com/design/DAG0Wo6i_So/ZZuUd1st2NiBMyat7ABFEA/edit?utm_content=DAG0Wo6i_So&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton) - Canva presentation slides
-   [Video Presentation](https://youtu.be/wan7k3aClZU) - YouTube demonstration video
...
-   [Agents Module](./docs/agents.md) - AI agent management documentation
-   [Meetings Module](./docs/meetings.md) - Meeting lifecycle management documentation
-   [Call Module](./docs/call.md) - Real-time video conferencing documentation
-   [Authentication Module](./docs/auth.md) - User authentication and authorization documentation
...
4. Put the webhook URL in Stream.io App
5. Run webhook server: `npm run dev:webhook`
6. Run Inngest development server: `npx inngest-cli@latest dev`
7. Set up environment variables (see `.env.example`)
8. Run database migrations: `npm run db:push`
9. View your database : `npm run db:studio`
