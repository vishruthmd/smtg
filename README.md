...
![Backend](/screenshots/Backend-Workflow.png)
...
_The authentication screen for accessing the SMTG platform_

### AI Agent Creation

![Agent Form](screenshots/Agent%20form.png)
_Creating a specialized AI agent with custom instructions_

![Extended Agent Form](screenshots/Agent%20Form%20extended.png)
_Detailed configuration options for AI agents_

### Meeting Setup

![Meeting Form](screenshots/meeting%20form.png)
_Scheduling a meeting with a specific AI agent_

### Meeting Interface

![Meeting Interface](screenshots/Meeting.png)
_Real-time video call interface with AI agent_

### Meeting Summary

![Summary](screenshots/Summary.png)
_AI-generated meeting summary with key points and action items_
